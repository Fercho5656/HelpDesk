<template>
  <div class="flex items-center justify-center gap-x-5">
    ...
    <label class="block">
      ...
      <input type="file"
        class="block w-full text-md text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-md file:font-semibold dark:file:bg-gray-500 dark:file:text-gray-300"
        @change="onChange" />
    </label>
  </div>
</template>
