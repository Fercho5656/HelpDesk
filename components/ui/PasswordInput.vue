<template>
  <label class="relative block text-sm font-medium text-gray-900 dark:text-gray-300">
    <p class="absolute top-0 -translate-y-full text-lg">{{label}}</p>
    ...
    <input
      class="appearance-none block w-full py-3 px-4 pl-14 rounded-md text-lg bg-gray-200 dark:bg-gray-500 dark:placeholder-gray-300 focus:outline-none"
